function [u] = LinwaveM2D(x,y,u,hx,hy,CFL,FinalTime)
% function [u] = LinwaveM2D(u,hx,hy,CFL,FinalTime)
% Purpose  : Integrate 2D Linwave equation until FinalTime 
...
rhsu4 = LinwaveMrhs2D(x,y,u4,hx,hy,k,maxvel);
